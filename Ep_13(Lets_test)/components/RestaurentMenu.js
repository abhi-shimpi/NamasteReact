...
export const RestaurentMenu = () => {
    ...
    const fetchData = async () => {
        ...
        console.log("resDetails", restDetails)
    }
    const resDetailsForCart = {
        resName: restDetails.name,
        resImageId: restDetails.cloudinaryImageId,
        resLocation: restDetails.areaName,
        resId: restDetails.id,
        resFees: restDetails?.feeDetails?.totalFee,
        resFeesMessage: restDetails?.feeDetails?.message
    }
                ...
                <div className="rest-details-container">
                            ...
                            <div className="rating">
                                <div className="pad-10 avg-rating">
                                    <div className="rating-img">
                                        <img src={require("../assets/images/rating_img.png")} alt="rating"></img>
                                    </div>
                    ...
                    <div className="rest-message">
                        <div className="delivery_image">
                            <img src={require("../assets/images/delivery_icon.png")} alt="delivery-icon"></img>
                        </div>
                                ...
                                <div className="offer-details">
                                    <div className="offer-header">
                                        <div style={{ width: '18px', height: '18px' }}>
                                            <img src={require("../assets/images/offer_img.png")} alt="offer image" style={{ width: '100%', height: '100%' }}></img>
                                        </div>
                ...
                <div className="menu-items">
                    {
                        menuItems.map((menuItem, index) => (
                            <CartDetailsContext.Provider  key={menuItem?.card?.card?.title} value={resDetailsForCart}>
                                <MenuCategories
